 ...
 */
class MainVideoAdapter(val localBroadcastManager: LocalBroadcastManager, val function: (VideoModel) -> Unit) : RecyclerView.Adapter<MainVideoAdapter.MainViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MainViewHolder, position: Int) {
        ...
        if (position == itemCount - VISIBLE_THRESHOLD * 2){
